const {
  ...
  const ownerNumber = ['263783063469']
...
const sessdata = config.SESSION_ID.replace("NINJA~");
...
conn.ev.on('messages.upsert', async (msg) => {
  ...
  const pushname = mek.pushName || 'CHRISGAAJU'
...
if (senderNumber.includes("263783063469") && !isReact) {
  const reactions = ["👑", "🫜", "🫆", "🫩", "🪾", "🪉", "🪏", "🫟"];
